...
clear
echo -e "\E[44;1;37m    INSTALACION DE PANEL SSHPLUS      \E[0m" 
echo ""
echo -e "\e[1;34;47m########################################################"
echo -e "\e[1;34;47m#        _____ _____ _____ _____ _                     #"              
...
echo -e "\e[1;34;47m# Este script funciona para ubuntu 14.                 #"
echo -e "\e[1;34;47m# No dispone del sistema Ubuntu 14?                    #"
...
echo -e "\n\033[1;36mINSTALANDO APACHE2 \033[1;33mAGUARDE...\033[0m"
...
echo ""
echo -ne "\033[1;32m ESCRIBA LA MISMA CONTRASEÑA\033[1;37m: "; read senha
sleep 1
...
sleep 1
cd
wget https://raw.githubusercontent.com/AAAAAEXQOSyIpN2JZ0ehUQ/SSHPLUS-MANAGER-FREE/master/Install/Panel_Web/panel_v20/banco.sql > /dev/null 2>&1
sleep 1
...
cd /bin
wget https://raw.githubusercontent.com/AAAAAEXQOSyIpN2JZ0ehUQ/SSHPLUS-MANAGER-FREE/master/Install/Panel_Web/panel_v20/html.sh > /dev/null 2>&1 && chmod 777 html.sh && sed -i -e 's/\r$//' html.sh && ./html.sh
...
service apache2 restart > /dev/null 2>&1
clear
echo -e "\033[1;32m PANEL-SSH INSTALADO CON EXITO!"
echo ""
echo -e "\033[1;36m PANEL:\033[1;37m http://$IP/admin\033[0m"
echo -e "\033[1;36m USUARIO:\033[1;37m admin\033[0m"
echo -e "\033[1;36m CONTRASENA:\033[1;37m admin\033[0m"
echo ""
echo -e "\033[1;33m Cambie la contrasena cuando acceda al panel>> Configuracoes>> Senha Antiga: admin >> Nova Senha: \033[0m"
